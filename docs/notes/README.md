...
This folder is the home for exploratory notes and drafts.
...
- [Context: Make Copilot an expert for your workspace](https://code.visualstudio.com/docs/copilot/reference/workspace-context)
- [Frontmatter instructions](https://code.visualstudio.com/docs/copilot/customization/custom-instructions)
- [Community-contributed agents, instructions, prompts, and configs](https://github.com/github/awesome-copilot)
