...
**Purpose:** Use the mounted project’s prompt modules for portfolio frontend work (11ty/Nunjucks/Tailwind v4/GSAP/Sanity).
**Top triggers:** explicit `frontend/` scope or stack cues (eleventy/11ty, Nunjucks, Tailwind v4, GSAP, AnimationBus, Director.js, Sanity content/collections, choreography).
